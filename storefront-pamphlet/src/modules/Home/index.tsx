...
const problems = [
  {
    ...
    desc: "Thousands spent on printing materials that become outdated quickly.",
  },
  {
    icon: MapPin,
    title: "Manual Distribution",
    desc: "Time-consuming physical delivery with limited reach and no tracking.",
  },
  {
    icon: RefreshCw,
    title: "Outdated Information",
    desc: "Static content that cannot be updated once printed.",
  },
  {
    icon: Users,
    title: "Limited Audience",
    desc: "Physical distribution restricts your reach to a small local area.",
  },
  {
    icon: BarChart3,
    title: "No Insights",
    desc: "Zero data on how many people viewed or engaged with your content.",
  },
  {
    icon: Leaf,
    title: "Environmental Waste",
    desc: "Thousands of pamphlets end up in landfills without being read.",
  },
];
const solutions = [
  {
    ...
    desc: "Create digital pamphlets shared instantly via links, QR codes, and social media.",
  },
  {
    icon: RefreshCw,
    title: "Real-Time Updates",
    desc: "Update content anytime with no reprinting or redistribution costs.",
  },
  {
    icon: BarChart3,
    title: "Analytics Dashboard",
    desc: "Track views, engagement, and distribution performance in real time.",
  },
  {
    icon: CheckCircle2,
    title: "Cost Effective",
    desc: "Eliminate printing and distribution costs entirely with a fully digital workflow.",
  },
];
...
const benefits = [
  {
    ...
    desc: "Eliminate printing and distribution expenses entirely.",
  },
  {
    icon: Globe,
    stat: "10x",
    label: "Wider Reach",
    desc: "Share pamphlets instantly through links, email, and social.",
  },
  {
    icon: RefreshCw,
    stat: "Real-time",
    label: "Instant Updates",
    desc: "Update content anytime without reprinting materials.",
  },
  {
    icon: TrendingUp,
    stat: "100%",
    label: "Trackable",
    desc: "Know exactly who viewed and engaged with your content.",
  },
  {
    icon: Users,
    stat: "Centralized",
    label: "One Platform",
    desc: "Manage all your pamphlets from a single dashboard.",
  },
  {
    icon: Leaf,
    stat: "Zero Waste",
    label: "Eco-Friendly",
    desc: "Go paperless and reduce your environmental footprint.",
  },
];
const howItWorks = [
  {
    ...
    icon: PenTool,
    title: "Create",
    desc: "Design or upload your pamphlet using our intuitive editor. Add images, rich text, and contact information.",
  },
  {
    step: "02",
    icon: Share2,
    title: "Publish",
    desc: "Share instantly through unique links, QR codes, or embed on your website. No printing required.",
  },
  {
    step: "03",
    icon: TrendingUp,
    title: "Analyze",
    desc: "Track views, engagement metrics, and distribution performance through your analytics dashboard.",
  },
];
const useCases = [
  {
    title: "Educational Institutions",
    desc: "Schools and universities sharing notices, event information, and academic materials.",
    icon: FileText,
    color: "from-blue-50 to-blue-100 text-blue-600",
  },
  {
    title: "Government Organizations",
    desc: "Public notices, awareness campaigns, and policy documents distributed digitally.",
    icon: Target,
    color: "from-green-50 to-green-100 text-green-600",
  },
  {
    title: "Healthcare",
    desc: "Health awareness campaigns, clinic information, and patient education materials.",
    icon: Leaf,
    color: "from-emerald-50 to-emerald-100 text-emerald-600",
  },
  {
    title: "Businesses",
    desc: "Marketing materials, promotional offers, and product catalogs shared with customers.",
    icon: TrendingUp,
    color: "from-purple-50 to-purple-100 text-purple-600",
  },
  {
    title: "NGOs & Non-Profits",
    desc: "Community outreach programs, fundraising campaigns, and impact reports.",
    icon: Users,
...
const testimonials = [
  {
    quote:
      "We reduced our annual printing budget by 80% while reaching 3x more people. ParchaHub transformed how we communicate with our community.",
    author: "Sarah Chen",
    role: "Communications Director, City Council",
  },
  {
    quote:
      "The analytics alone are worth it. For the first time, we can actually measure how many people read our materials and which content resonates.",
    author: "James Okonkwo",
    role: "Head of Outreach, HealthFirst NGO",
  },
  {
    quote:
      "Updating our pamphlets used to take weeks of reprinting and redistribution. Now we make changes in minutes and everyone gets the latest version instantly.",
    author: "Priya Sharma",
    role: "Marketing Manager, EduPrime Schools",
  },
];
const stats = [
...
const Home = () => {
    ...
    const load = async () => {
      try {
        ...
        const items = Array.isArray(pamData)
          ? pamData
          : (pamData as PamphletPayload)?.data ||
            (pamData as PamphletPayload)?.items ||
            [];
        setPamphlets(items);
      } catch {
        /* ignore */
  ...
  return (
    <div className="overflow-hidden">
      ...
      <section
        id="solution"
        className="py-20 md:py-28 px-4 bg-gradient-to-b from-neutral-50 to-white"
      >
        <div className="max-w-7xl mx-auto">
          <FadeInSection>
            <SectionHeading
          ...
          <FadeInSection>
            <div className="max-w-3xl mx-auto mb-16 bg-white rounded-2xl border border-neutral-100 shadow-soft overflow-hidden">
              <div className="grid grid-cols-3 border-b border-neutral-100 bg-neutral-50">
                ...
                <div className="p-4 text-sm font-semibold text-red-500 uppercase tracking-wide text-center border-x border-neutral-100">
                  Traditional
                </div>
                <div className="p-4 text-sm font-semibold text-green-600 uppercase tracking-wide text-center">
                  ParchaHub
                </div>
              </div>
              {comparisonData.map((row, i) => (
                <div
                  key={i}
                  className={`grid grid-cols-3 ${i < comparisonData.length - 1 ? "border-b border-neutral-50" : ""}`}
                >
                  <div className="p-4 text-sm text-neutral-700 font-medium">
          ...
          <FadeInSection>
            <div className="bg-neutral-900 rounded-3xl p-6 md:p-10 shadow-soft max-w-5xl mx-auto">
              <div className="grid grid-cols-2 md:grid-cols-5 gap-3 mb-8">
                {["Dashboard", "Create", "Analytics", "Manage", "Users"].map(
                  (tab, i) => (
                    <div
                      key={i}
                      className={`px-4 py-2 rounded-lg text-xs font-semibold text-center transition-colors ${i === 0 ? "bg-white/10 text-white" : "text-neutral-400 hover:text-white"}`}
                    >
                      {tab}
                    </div>
                  ),
              ...
              <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="flex items-center gap-4 text-xs text-neutral-400">
                    <span>
                      Views: <strong className="text-white">12,847</strong>
                    </span>
                    <span>
                      Engagement: <strong className="text-white">34%</strong>
                    </span>
                  </div>
                </div>
            ...
            {useCases.map((uc, i) => (
              <FadeInSection key={i}>
                <div className="p-6 rounded-2xl bg-white border border-neutral-100 hover:shadow-soft transition-all duration-300 hover:-translate-y-0.5">
                  <div
                    className={`w-12 h-12 rounded-xl bg-gradient-to-br ${uc.color} flex items-center justify-center mb-4`}
                  >
                    <uc.icon size={20} />
                  </div>
                  <h3 className="text-base font-bold text-neutral-900 mb-2">
            ...
            <div className="max-w-4xl mx-auto bg-neutral-900 rounded-3xl p-6 md:p-10 shadow-soft">
              ...
              <div className="bg-white/5 rounded-xl p-6 border border-white/5">
                ...
                <div className="flex items-end gap-1.5 h-28">
                  {[
                    40, 55, 38, 62, 48, 70, 52, 58, 42, 65, 50, 72, 68, 55, 80,
                    62, 45, 75, 58, 82, 70, 60, 78, 85, 72, 90, 68, 75, 88, 95,
                  ].map((h, i) => (
                    <div
                      key={i}
                      className="flex-1 rounded-t-sm bg-brand-blue/30 hover:bg-brand-blue/50 transition-colors"
                      style={{ height: `${h}%` }}
                    />
                  ))}
                </div>
          ...
          <FadeInSection>
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-neutral-500 max-w-2xl mx-auto leading-relaxed mb-8">
                Every digital pamphlet saves trees, reduces carbon emissions,
                and eliminates waste. Join thousands of organizations choosing
                    ...
                    >
                      <article className="p-4 rounded-2xl bg-white border border-neutral-100 hover:shadow-soft transition-all duration-300 hover:-translate-y-1 h-full">
                        {thumbUrl ? (
                          ...
                          <div className="w-full aspect-[4/3] rounded-xl bg-neutral-100 flex items-center justify-center text-sm text-neutral-400 mb-4">
                            No image
                          </div>
                        )}
                        ...
                        <h3 className="mt-1 text-base font-bold text-neutral-900 group-hover:text-brand-blue transition-colors line-clamp-1">
                          {item.title}
                        </h3>
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          <FadeInSection>
            ...
            <p className="mt-6 text-lg text-blue-100/80 max-w-xl mx-auto leading-relaxed">
              Join thousands of organizations already saving time, money, and
